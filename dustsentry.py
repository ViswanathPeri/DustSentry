...
def scan_directory(path):
    ...
    for entry in suspicious:
        print(f"⚠️ {entry['path']} → Score: {entry['score']}")
...
if __name__ == "__main__":
    ...
    if not args.directory:
        args.directory = input("Please enter the path to the directory to scan: ")
    ...
    print("\nScan completed. The window will remain open until you close it manually.")
    while True:
